...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ExtactIoRmsGeneratedClientJs.AddRentalItemDto();
  });
  ...
  describe('AddRentalItemDto', function() {
    it('should create an instance of AddRentalItemDto', function() {
      // uncomment below and update the code to test AddRentalItemDto
      //var instance = new @ExtactIoRmsGeneratedClientJs.AddRentalItemDto();
      //expect(instance).to.be.a(@ExtactIoRmsGeneratedClientJs.AddRentalItemDto);
    });
