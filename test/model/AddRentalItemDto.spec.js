...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RmsGeneratedClientJs.AddRentalItemDto();
  });
  ...
  describe('AddRentalItemDto', function() {
    it('should create an instance of AddRentalItemDto', function() {
      ...
      //var instance = new RmsGeneratedClientJs.AddRentalItemDto();
      //expect(instance).to.be.a(RmsGeneratedClientJs.AddRentalItemDto);
    });
