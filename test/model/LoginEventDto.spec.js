...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ExtactIoRmsGeneratedClientJs.LoginEventDto();
  });
  ...
  describe('LoginEventDto', function() {
    it('should create an instance of LoginEventDto', function() {
      ...
      //var instance = new @ExtactIoRmsGeneratedClientJs.LoginEventDto();
      //expect(instance).to.be.a(@ExtactIoRmsGeneratedClientJs.LoginEventDto);
    });
