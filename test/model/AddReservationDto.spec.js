...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RmsGeneratedClientJs.AddReservationDto();
  });
  ...
  describe('AddReservationDto', function() {
    it('should create an instance of AddReservationDto', function() {
      ...
      //var instance = new RmsGeneratedClientJs.AddReservationDto();
      //expect(instance).to.be.a(RmsGeneratedClientJs.AddReservationDto);
    });
