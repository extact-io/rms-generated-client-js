...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ExtactIoRmsGeneratedClientJs.AddUserAccountDto();
  });
  ...
  describe('AddUserAccountDto', function() {
    it('should create an instance of AddUserAccountDto', function() {
      ...
      //var instance = new @ExtactIoRmsGeneratedClientJs.AddUserAccountDto();
      //expect(instance).to.be.a(@ExtactIoRmsGeneratedClientJs.AddUserAccountDto);
    });
