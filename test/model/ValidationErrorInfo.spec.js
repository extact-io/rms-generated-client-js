...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ExtactIoRmsGeneratedClientJs.ValidationErrorInfo();
  });
  ...
  describe('ValidationErrorInfo', function() {
    it('should create an instance of ValidationErrorInfo', function() {
      ...
      //var instance = new @ExtactIoRmsGeneratedClientJs.ValidationErrorInfo();
      //expect(instance).to.be.a(@ExtactIoRmsGeneratedClientJs.ValidationErrorInfo);
    });
