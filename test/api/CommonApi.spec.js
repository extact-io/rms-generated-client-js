...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ExtactIoRmsGeneratedClientJs.CommonApi();
  });
  ...
  describe('CommonApi', function() {
    describe('getOwnUserProfile', function() {
      it('should call getOwnUserProfile successfully', function(done) {
        //uncomment below and update the code to test getOwnUserProfile
        //instance.getOwnUserProfile(function(error) {
