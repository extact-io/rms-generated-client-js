...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ExtactIoRmsGeneratedClientJs.AuthenticateApi();
  });
  ...
  describe('AuthenticateApi', function() {
    ...
    describe('authenticateForTest', function() {
      it('should call authenticateForTest successfully', function(done) {
        //uncomment below and update the code to test authenticateForTest
        //instance.authenticateForTest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
