...
export default class AdminApi {
    ...
    */
    ...
    addRentalItemWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = opts['addRentalItemEventDto'];
    ...
    addUserAccountWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = opts['addUserAccountEventDto'];
     ...
     */
    deleteRentalItemWithHttpInfo(itemId) {
      let postBody = null;
    ...
    deleteRentalItem(itemId) {
      return this.deleteRentalItemWithHttpInfo(itemId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    deleteReservationWithHttpInfo(reservationId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/rms/reservations/{reservationId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    deleteUserAccountWithHttpInfo(userAccountId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/rms/users/{userAccountId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
