...
export default class MemberApi {
    ...
    */
    ...
    addReservationWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = opts['addReservationEventDto'];
     ...
     */
    canRentedItemAtTermWithHttpInfo(itemId, from, to) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/api/rms/items/{itemId}/rentable', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    canRentedItemAtTerm(itemId, from, to) {
      return this.canRentedItemAtTermWithHttpInfo(itemId, from, to)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    cancelReservationWithHttpInfo(reservationId) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/rms/reservations/own/{reservationId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    findReservationByRentalItemAndStartDateWithHttpInfo(itemId, startDate) {
      ...
      let returnType = [ReservationResourceDto];
      return this.apiClient.callApi(
        '/api/rms/reservations/item/{itemId}/startdate/{startDate}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:dto/ReservationResourceDto>} and HTTP response
     */
    findReservationByRentalItemIdWithHttpInfo(itemId) {
      let postBody = null;
      // verify the required parameter 'itemId' is set
      if (itemId === undefined || itemId === null) {
      ...
      let returnType = [ReservationResourceDto];
      return this.apiClient.callApi(
        '/api/rms/reservations/item/{itemId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:dto/ReservationResourceDto>}
     */
    findReservationByRentalItemId(itemId) {
      return this.findReservationByRentalItemIdWithHttpInfo(itemId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    findReservationByReserverIdWithHttpInfo(reserverId) {
      ...
      let returnType = [ReservationResourceDto];
      return this.apiClient.callApi(
        '/api/rms/reservations/reserver/{reserverId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
